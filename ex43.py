...
class Death(Scene):
    quips = ["You died. You kindda suck at this.",
...
In the middle of your artful dodge you foot slips and you
...
Lbhe lmkjq jflmq jfmlqdsk lkmdqs jfsdqkljm mqsmqd dlsq ldldfjqm.
...
bomb. The code is 3 digits.
        ...
        while guess != code and guesses < 10:
            ...
            if int(guess) < int(code):
                print("[LOCKER SCREEN] Guess is to small")
            elif int(guess) > int(code):
                print("[LOCKER SCREEN] Guess is to big")
            else:
                print("[LOCKER SCREEN] Guess is right")
            guesses += 1
...
and make a leap for the door. Right as you frop it a
...
class EscapePod(Scene):
    def enter(self):
        print("""You rush through th eship desperatly trying to make it to
